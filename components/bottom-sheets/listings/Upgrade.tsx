...
const UpgradeBottomSheet = forwardRef<BottomSheetModal, AddBottomSheetProps>(
    ({ header }, ref) => {
            ...
            >
                <BottomSheetView className='px-8'> 
                    <View className="items-center mt-4 mb-16">
                        ...
                        <Text className="text-center text-2xl font-medium text-dark w-3/4 mb-4">Upgrade & Sell More</Text>
                        <Text className="text-center text-base font-regular text-light mb-8">
                            You can only have 4 active listings at a time. Upgrade to premium for unlimited listings, or set an active listing to a draft.
                        </Text>
                        <CustomButton title="Upgrade to Premium" className="w-full" />
